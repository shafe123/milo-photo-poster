...
import function_app
from function_app import select_best_photo, get_recent_blobs, is_blob_posted, mark_blob_as_posted, POSTED_METADATA_KEY
...
def test_mark_blob_as_posted():
    ...
    from function_app import mark_blob_as_posted, POSTED_METADATA_KEY
...
def test_is_blob_posted_returns_false_for_unposted():
    ...
    from function_app import is_blob_posted
...
def test_is_blob_posted_returns_true_for_recently_posted():
    ...
    from function_app import is_blob_posted, POSTED_METADATA_KEY
